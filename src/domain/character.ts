...
export type Character = {
  ...
  initialMessage: string; // 初回メッセージ
};

export const beginnerCharacterPreset = {
  id: "BEGINNER",
  name: "佐藤 健太",
  ...
  description:
    "若く意欲的な営業マン。新しいアイデアや提案に対して前向きで、相手の熱意や誠実さに心を動かされやすい。細かいデータよりも「これは面白そう！」「なんか良さそう！」という直感で判断することが多い。友好的で話しやすく、相手との関係性を重視する。ただし、上司の意見は気にする傾向がある。説得のポイントは、親しみやすさと熱意を示し、難しい話よりもメリットを分かりやすく伝えること。",
  shortIntro: "新しいものが大好きな営業新人。熱意と関係性を重視。",
  initialMessage:
    "あ、どうも！佐藤です！今日はわざわざ来てもらってありがとうございます〜。えーっと、何か提案があるって聞いてるんですけど...正直、今の状況で特に困ってないんですけど、でも新しいことには興味あるんで、どんな話なのか聞かせてもらえますか？",
} as const satisfies Character;

export const intermediateCharacterPreset = {
  id: "INTERMEDIATE",
  name: "鈴木 美香",
  ...
  initialMessage:
    "鈴木です、購買部のマネージャーをしています。本日はお時間をいただきありがとうございます。何かご提案があるとのことですが、どのような内容でしょうか。私たちも常により良い方法を模索していますので、まずは詳しくお聞かせください。",
} as const satisfies Character;

export const expertCharacterPreset = {
  id: "EXPERT",
  name: "高橋 誠一",
  ...
  initialMessage:
    "高橋です。わざわざお越しいただいたということは、何か重要なお話があるのでしょう。まずは内容をお聞かせください。ただし、最初に申し上げておきますが、我が社は30年以上の歴史があり、簡単に方針を変えることはありません。",
} as const satisfies Character;
